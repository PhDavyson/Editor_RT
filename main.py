...
class Editor_RT(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle(f'Editor de Textos RichText')
        self.showMaximized()
    ...
    def create_tool_bar(self):
        ...
        justificationAllign = QAction(QIcon('justification-align.png'), 'Justification Allign', self)
        justificationAllign.triggered.connect(lambda : self.editor.setAlignment(Qt.AlignJustification))
        toolbar.addAction(justificationAllign)
